...
.service('RoleService', ['$q', '$http', function($q, $http){
  ...
  this.deleteRole = function(role){
    ...
    var postData = {params:{filter: 'id='+role.id}};

    $http.delete('/api/v2/mysql/_table/roles',postData).then(function(resp) {
      console.log("Success: "+resp.data);
      deferred.resolve(resp.data);
    }, function(err) {
      console.error('ERR', err);
  ...
  this.editRole = function(role){
    ...
    $http.put('/api/v2/mysql/_table/roles',putData).then(function(resp) {
      deferred.resolve(resp.data.resource);
    }, function(err) {
...
.service('ColorService', ['$q', '$http',function($q,$http){
  ...
  this.deleteColor = function(color){
    ...
    var postData = {params:{filter: 'id='+color.id}};

    $http.delete('/api/v2/mysql/_table/colors',postData).then(function(resp) {
      console.log("Success: "+resp.data);
      deferred.resolve(resp.data);
    }, function(err) {
      console.error('ERR', err);
  ...
  this.editColor = function(color){
    ...
    $http.put('/api/v2/mysql/_table/colors',putData).then(function(resp) {
      deferred.resolve(resp.data.resource);
    }, function(err) {
      console.error('ERR', JSON.stringify(err));
      deferred.reject(err);
...
.service('ProductService',['$q', '$http', 'S3Service', function($q, $http, S3Service){
  ...
  this.deleteProduct = function(product){
    ...
    var postData = {params:{filter: 'id='+product.id}};

    $http.delete('/api/v2/mysql/_table/products',postData).then(function(resp) {
      console.log("Success: "+resp.data);
      deferred.resolve(resp.data);
    }, function(err) {
      console.error('ERR', err);
  ...
  this.editProduct = function(product){
    ...
    if(product.blob){
      ...
      S3Service.uploadEditedPicture("product-images",imageName,product.blob).then(function(resp){
        ...
        console.log("Picture successfully uploaded: "+JSON.stringify(resp));
      }, function(err){
        console.log("Could not upload picture: "+JSON.stringify(err));
      });
      return deferred.promise;
      console.log("Changing Product: "+JSON.stringify(product));
    }
    else{
      var deferred = $q.defer();
...
.service('CategoryService',['$q', '$http', function($q, $http){
  ...
  this.deleteCategory = function(category){
    ...
    var postData = {params:{filter: 'id='+category.id}};

    $http.delete('/api/v2/mysql/_table/category',postData).then(function(resp) {
      console.log("Success: "+resp.data);
      deferred.resolve(resp.data);
    }, function(err) {
      console.error('ERR', err);
  ...
  this.editCategory = function(category){
    ...
    $http.put('/api/v2/mysql/_table/category',putData).then(function(resp) {
      deferred.resolve(resp.data.resource);
    }, function(err) {
      console.error('ERR', JSON.stringify(err));
      deferred.reject(err);
...
.service('S3Service', ['$q', '$http', function($q, $http){
  ...
  this.uploadEditedPicture = function(folder,imageName,image){
    ...
    $http.put('/api/v2/s3/'+folder+'/'+imageName,putData).then(function(resp) {
      console.log("Success: "+resp.data);
      deferred.resolve(resp);
    }, function(err) {
      console.error('ERR', err);
